...
do
  python generate_unquantized_random_drums_midi_file.py -n "random_"$i".mid" -p "../datasets/quantized_rythm_dataset/0/"
done
...
--output_dir=/Users/Cyril_Musique/Documents/Cours/M2/MuGen/datasets/quantized_rythm_dataset/100 \
